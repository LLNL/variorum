                           ...
                           off_t *msrs_fixed_ctrs)
{
    ...
    {
        init = 1;
        variorum_get_topology(NULL, NULL, &nthreads, P_INTEL_IDX);
                                ...
                                off_t *msrs_pcu_pmon_evtsel)
{
    ...
    variorum_get_topology(&nsockets, NULL, NULL, P_INTEL_IDX);
                              ...
                              off_t msr_fixed_counter_ctrl, off_t msr_aperf, off_t msr_mperf, off_t msr_tsc)
{
    ...
    variorum_get_topology(&nsockets, NULL, &nthreads, P_INTEL_IDX);
    gethostname(hostname, 1024);
