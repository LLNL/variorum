...
int set_intel_func_ptrs(void)
{
    ...
    else if (*g_platform.intel_arch == FM_06_3E)
    {
        ...
        g_platform.variorum_print_available_frequencies = fm_06_3e_get_frequencies;
    }
    // Haswell 06_3F
    else if (*g_platform.intel_arch == FM_06_3F)
    {
        ...
        g_platform.variorum_print_available_frequencies = fm_06_3f_get_frequencies;
    }
    // Broadwell 06_4F
    else if (*g_platform.intel_arch == FM_06_4F)
    {
        ...
        g_platform.variorum_print_available_frequencies = fm_06_4f_get_frequencies;
