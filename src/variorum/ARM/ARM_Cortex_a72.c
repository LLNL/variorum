...
int arm_cortex_a72_get_power(int long_ver)
{
    ...
    ret = arm_cpu_cortex_a72_get_power_data(long_ver, stdout);
...
int arm_cortex_a72_get_thermals(int long_ver)
{
    ...
    ret = arm_cpu_cortex_a72_get_thermal_data(long_ver, stdout);
...
int arm_cortex_a72_get_clocks(int long_ver)
{
    ...
    {
        ret = arm_cpu_cortex_a72_get_clocks_data(iter, long_ver, stdout);
    }
...
int arm_cortex_a72_get_frequencies(void)
{
    ...
    for (iter = 0; iter < nsockets; iter++)
    {
        ret = arm_cpu_cortex_a72_get_frequencies(iter, stdout);
    }
...
int arm_cortex_a72_cap_socket_frequency(int cpuid, int freq)
{
    ...
    ret = arm_cpu_cortex_a72_cap_socket_frequency(cpuid, freq);
...
int arm_cortex_a72_get_power_json(char **get_power_obj_str)
{
    ...
    ret = arm_cpu_cortex_a72_json_get_power_data(get_power_obj);
...
int arm_cortex_a72_get_power_domain_info_json(char **get_domain_obj_str)
{
    ...
    ret = arm_cpu_cortex_a72_json_get_power_domain_info(get_domain_obj);
