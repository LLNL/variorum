...
int set_amd_gpu_func_ptrs(int idx)
{
    ...
    if (*g_platform[idx].arch_id == AMD_INSTINCT)
    {
        ...
        g_platform[idx].variorum_print_power_limit = amd_gpu_instinct_get_power_limit;
        ...
        g_platform[idx].variorum_get_gpu_utilization_json = amd_gpu_instinct_get_gpu_utilization_json;
        /* Initialize control interfaces */
        g_platform[idx].variorum_cap_each_gpu_power_limit = amd_gpu_instinct_cap_each_gpu_power_limit;
        /* Initialize JSON interfaces */
        g_platform[idx].variorum_get_power_json = amd_gpu_instinct_get_power_json;
    }
    else
    {
