...
if(VARIORUM_WITH_NVIDIA_GPU)
    message(STATUS "Building support for Nvidia architectures (VARIORUM_WITH_NVIDIA_GPU == ON)")
else()
    message(STATUS "Building without support for Nvidia architectures (VARIORUM_WITH_NVIDIA_GPU == OFF)")
endif()
