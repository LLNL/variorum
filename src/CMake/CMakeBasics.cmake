...
if(VARIORUM_WITH_INTEL_DGPU)
    message(STATUS "Building support for Intel DGPU architectures (VARIORUM_WITH_INTEL_DGPU == ON)")
else()
    message(STATUS "Building without support for Intel DGPU architectures (VARIORUM_WITH_INTEL_DGPU == OFF)")
endif()
